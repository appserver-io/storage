...
/**
 * AppserverIo\Storage\Mock\MockThreadedContext
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\Storage\GenericThreaded;
 ...
 * @link      http://www.appserver.io
 */
class MockThreadedContext extends GenericThreaded
{
     ...
     *
     * @param \AppserverIo\Storage\GenericThreaded $storage The storage we want to use
     *
     * @return void
     */
    public function injectStorage(GenericThreaded $storage)
    {
